...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname E46) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(check-expect (render 0) (place-image CAT2 0 DY MT))
(check-expect (render 4) (place-image CAT2 4 DY MT))
(check-expect (render 7) (place-image CAT 7 DY MT))

(define (render ws)
  (cond [(odd? ws) (place-image CAT ws DY MT)]
        [else (place-image CAT2 ws DY MT)]))
